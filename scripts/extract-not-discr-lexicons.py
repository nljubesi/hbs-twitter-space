...
presverbsdict, chdict, infverbsdict, genitiv_og_dict, verbs_dict, vmfverbsdict, modalsdict, desavati_dict, dogadjati_dict\
    = {},{},{},{},{},{},{},{},{}
...
for myfile in [lexicon_dirs+'/hrLex_v1.0.gz', lexicon_dirs+'/srLex_v1.0.gz']:
    for line in gzip.open(myfile):
      ...
      elif lemma ==u"događati" or lemma==u"dogoditi":
          get_into_dict(lemma, dogadjati_dict)
      elif lemma ==u"desiti" or lemma==u"dešavati":
